...
<p>
Now, we will copy our application code to the EC2 instance. To copy our application, we will install WinSCP (WinSCP is a popular SFTP client and FTP client for Microsoft Windows). Please download and install from <a href="https://winscp.net/eng/download.php" target="_blank">here</a> 
</p>
